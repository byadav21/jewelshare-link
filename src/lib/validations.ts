...
export const productImportSchema = z.object({
  ...
  image_url: z.string().url("Invalid image URL").max(500, "URL must be less than 500 characters").nullable(),
...
export const gemstoneImportSchema = z.object({
  ...
  image_url: z.union([z.string().url().max(500), z.null()]),
  image_url_2: z.union([z.string().url().max(500), z.null()]),
  image_url_3: z.union([z.string().url().max(500), z.null()]),
...
export const diamondImportSchema = z.object({
  ...
  image_url_2: z.string().url().max(500).nullable(),
  image_url_3: z.string().url().max(500).nullable(),
  price_inr: z.number().min(0.01, "Price must be greater than 0"),
  price_usd: z.number().min(0).nullable(),
  stock_quantity: z.number().int().min(0).max(100000),
