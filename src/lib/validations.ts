...
export const gemstoneImportSchema = z.object({
  ...
  image_url: z.union([z.string().url().max(500), z.null()]).nullable(),
  image_url_2: z.union([z.string().url().max(500), z.null()]).nullable(),
  image_url_3: z.union([z.string().url().max(500), z.null()]).nullable(),
