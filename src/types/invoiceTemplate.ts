...
export const DEFAULT_SECTIONS: TemplateSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'diamond_weight', label: 'Diamond Wt.', key: 'diamondWeight', visible: true, order: 4 },
      { id: 'diamond_per_carat', label: 'Diamond ₹/Ct', key: 'diamondPerCarat', visible: true, order: 5 },
      { id: 'diamond_cost', label: 'Diamond Cost', key: 'diamondCost', visible: true, order: 6 },
      { id: 'stone_weight', label: 'Stone Wt.', key: 'stoneWeight', visible: true, order: 7 },
      { id: 'stone_per_carat', label: 'Stone ₹/Ct', key: 'stonePerCarat', visible: true, order: 8 },
      { id: 'stone_cost', label: 'Stone Cost', key: 'stoneCost', visible: true, order: 9 },
      { id: 'net_weight', label: 'Net Wt.', key: 'netWeight', visible: true, order: 10 },
      { id: 'gold_rate', label: 'Gold Rate', key: 'goldRate', visible: true, order: 11 },
      { id: 'gold_cost', label: 'Gold Cost', key: 'goldCost', visible: true, order: 12 },
      { id: 'making_charges_per_gram', label: 'MC/Gram', key: 'makingChargesPerGram', visible: true, order: 13 },
      { id: 'total_making', label: 'Total MC', key: 'totalMaking', visible: true, order: 14 },
      { id: 'cad_charges', label: 'CAD Charges', key: 'cadCharges', visible: true, order: 15 },
      { id: 'camming_charges', label: 'Camming', key: 'cammingCharges', visible: true, order: 16 },
      { id: 'certification', label: 'Certification', key: 'certification', visible: true, order: 17 },
      { id: 'tax', label: 'Tax', key: 'tax', visible: true, order: 18 },
      { id: 'shipping', label: 'Shipping', key: 'shipping', visible: true, order: 19 },
      { id: 'amount', label: 'Total Amount', key: 'amount', visible: true, order: 20 },
    ],
    styling: {
      backgroundColor: 'transparent',
      padding: 16,
