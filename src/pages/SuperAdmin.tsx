...
import { ArrowLeft, Users, LogOut, Monitor, Search, TrendingUp, Database, Shield, FileDown, History, Settings, Crown, Bookmark } from "lucide-react";
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-3 sm:px-6 py-4 sm:py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 max-w-6xl mx-auto">
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer active:scale-[0.98] border-primary/50 bg-gradient-to-br from-primary/5 to-transparent" onClick={() => navigate("/permission-presets")}>
              <CardHeader className="p-4 sm:p-6">
                <CardTitle className="flex items-center gap-2 sm:gap-3 text-base sm:text-lg">
                  <Bookmark className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                  Permission Presets
                  <Badge variant="secondary" className="ml-auto text-xs">Templates</Badge>
                </CardTitle>
                <CardDescription className="text-xs sm:text-sm">Create reusable permission templates</CardDescription>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <Button className="w-full h-9 sm:h-10 text-xs sm:text-sm" variant="default">
                  Manage Templates
