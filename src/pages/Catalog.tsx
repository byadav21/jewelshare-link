        ...
        <main className="container mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-10 max-w-[1800px]">
          ...
          {loading ? <div className="space-y-8 animate-fade-in">
            ...
            delay: 0.2
              ...
              {filteredProducts.length === 0 ? <div className="text-center py-12 sm:py-16 px-4">
                  <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-muted/50 mb-4 sm:mb-6">
                    <Gem className="h-7 w-7 sm:h-8 sm:w-8 text-muted-foreground" />
                  </div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-foreground">No products found</h3>
                  <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6">Try adjusting your filters</p>
